...
#if BAR_PANGO_PATCH
static const char font[]                 = "Times New Roman:size=20:style=Bold"; //IcoMoon, Roboto, Fira Code, FantasqueSansM Nerd Font
#else
static const char *fonts[] 				 = {"Times New Roman:size=20:style=Bold", "NotoColorEmoji:pixelsize=20:antialias=true:autohint=true", "DejaVu Sans Mono:size=20","FontAwesome:pixelsize=20:antialias=true:autohint=true", "SymbolsNerdFont:weight=bold:size=20"}; // (DWMBLOCKS | DWMBAR FONT)
#endif // BAR_PANGO_PATCH
static const char dmenufont[]            = "Dina:size=20";
...
static const Key keys[] = {
	...
	{ MODKEY|Mod4Mask,              XK_Up,         inplacerotate,          {.i = +2 } }, // same as rotatestack
	{ MODKEY|Mod4Mask,              XK_Down,       inplacerotate,          {.i = -2 } }, // same as reotatestack
	...
	{ 0,			                XK_KP_Delete,  togglefloating,         {0} },
	#if MAXIMIZE_PATCH
